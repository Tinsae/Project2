var monthInfo = [["January",31], ["February", 28], ["March",31], ["April", 30], ["May",31], ["June",30],
        ...
        function onWindowLoad(){
            Visualforce.remoting.Manager.invokeAction(
                '{!$RemoteAction.AppointmentCalendarController.getDoctorInfo}', '{!doctor}',function(result){
                    startTime = result[0] /3600000;
                    endTime = result[1] / 3600000;
                    doctor = result[2];
                    address = result[3];
                    Visualforce.remoting.Manager.invokeAction(
                        '{!$RemoteAction.AppointmentCalendarController.getAppointmentInfo}', '{!doctor}',function(result){
        ...
        function createAppointment(){
            ...
            Visualforce.remoting.Manager.invokeAction(
                '{!$RemoteAction.AppointmentCalendarController.createAppointment}', 
                 dateArray[0], dateArray[1], dateArray[2], dateArray[3], '{!doctor}', '{!patient}',function(result){}
            );
        }
